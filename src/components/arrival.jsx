...
function Arrival({ secname, sectag, imgtitle, imgtag, asideimg }) {
    ...
    return (
        <div className="box-border w-full py-10! overflow-hidden relative flex items-center justify-center" style={{ background: `url(${arrivalbg})`, backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
            ...
            <div className="arrival-container box-border flex max-md:flex-col items-center justify-center gap-10 w-[80%] desktop-md:w-[95%] h-full! relative z-10 px-[5%]">
                ...
                <motion.aside
                    ...
                    className='w-[30%] max-md:w-full h-[80vh] desktop-md:h-[70vh] max-md:h-[40vh] rounded-[20px] border border-white/20 relative flex items-center justify-center overflow-hidden shadow-[0_0_40px_rgba(211,97,235,0.15)] group cursor-pointer'
                >
                    ...
                    >
                        <h2 className="text-[40px] font-bold text-white drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">{imgtitle}</h2>
                        <h6 className="text-[#d3b195] tracking-[6px] mt-2 text-sm uppercase font-semibold drop-shadow-md">{imgtag}</h6>
                    </motion.div>
                </motion.aside>
                ...
                >
                    <motion.div 
                        className="text desktop-md:leading-10! w-full flex flex-col items-center justify-center mb-10"
                    ...
                    <div className='flex gap-10 desktop-md:gap-14 w-full'>
                        ...
                        <Link to="/" key={product.id} className='w-1/3 max-md:w-full flex flex-col items-center justify-center relative group'>
                            ...
                            >
                                <motion.img 
                                    className='w-[80%] object-contain drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)] mb-6' 
                                    src={product.img} 
                                    alt={product.name} 
