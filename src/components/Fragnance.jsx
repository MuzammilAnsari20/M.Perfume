...
function Fragnance() {
    return (
        <section className="relative box-border w-full py-[50px]! max-md:py-[10px]! desktop-md:py-[80px]! pb-[100px]! max-md:pb-[50px]! overflow-hidden my-[30px]! flex items-center justify-center min-h-[80vh]! max-md:h-auto!">
            ...
            <motion.div 
                className="absolute top-0 left-0 h-[90vh] max-md:h-full desktop-md:h-[90vh] bg-gradient-to-br from-[#140016] to-[#2a0033] z-0 max-md:hidden"
                variants={bgVariants}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: false, amount: 0.2 }}
            ...
            <div className="w-[1180px] desktop-md:w-[85%] max-w-[95%] mx-auto flex max-md:flex-col-reverse items-center justify-between relative z-10 gap-10 max-md:gap-0">
                ...
                <motion.div className="w-[50%] max-md:w-full text-white max-md:text-center max-md:flex max-md:flex-col max-md:items-center" variants={textContainer}
                    ...
                    <motion.p className="text-[#D361EB] tracking-[8px] text-[13px]! desktop-md:text-[16px]! mb-[20px]! uppercase font-bold" variants={itemUp}>
                        Our Fragrance Journey
                    </motion.p>

                    <motion.h2 className="text-[42px]! max-md:text-[28px]! desktop-md:text-[64px]! font-extrabold leading-[1.1]! mb-[25px]! drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" variants={titleVariants} style={{ perspective: 1000 }}>
                        Crafting Scents with <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E670FB] to-[#d3b195]">Passion & Precision</span>
                    </motion.h2>

                    <motion.p className="text-[14px]! desktop-md:text-[18px]! text-[#cfcfcf] leading-[1.8]! mb-[15px]! max-w-[500px]" variants={itemUp}>
                    ...
                    <motion.p className="text-[14px]! desktop-md:text-[18px]! text-[#cfcfcf] leading-[1.8]! mb-[25px]! max-w-[500px]" variants={itemUp}>
                    ...
                    <motion.div variants={itemUp} whileHover={{ scale: 1.1, rotate: 2 }} whileTap={{ scale: 0.9 }} className="mt-[15px]!">
                        <motion.div animate={pulseButton} className="inline-block rounded-[30px]!">
                            <Link to="/men" className="inline-block px-[32px]! py-[14px]! desktop-md:px-[45px]! desktop-md:py-[20px]! desktop-md:text-[20px]! bg-gradient-to-r from-[#E670FB] to-[#7c30b3] text-white rounded-[30px]! no-underline text-[16px]! font-bold border-2 border-[#E670FB]/50 transition-all hover:bg-gradient-to-l">
                                Discover Now
                            </Link>
                        </motion.div>
                    </motion.div>
                ...
                <motion.div className="w-[45%] max-md:w-full max-md:mt-[40px]! max-md:mb-[60px]! relative h-[450px]! desktop-md:h-[600px]! max-md:flex max-md:flex-col max-md:items-center max-md:justify-center"
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: false, margin: "-10% 0px" }}
                >
                    ...
                    <motion.div 
                        className="absolute max-md:relative left-[-20px]! max-md:left-[0px]! bottom-[40px]! max-md:mt-[-100px]! max-md:bottom-0! w-[50%] max-md:w-[60%] h-[55%] max-md:h-[250px]! z-20 drop-shadow-[0_30px_30px_rgba(0,0,0,0.8)]"
